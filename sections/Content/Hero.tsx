          ...
          >
            ...
            <div class="flex flex-col items-center lg:items-start lg:flex-row gap-4">
              {cta?.map((item) => (
                ...
                >
                  <span class="ease absolute right-0 -mt-12 h-32 w-8 translate-x-12 rotate-12 transform bg-base-100 opacity-10 transition-all duration-1000 group-hover:-translate-x-40">
                  </span>
